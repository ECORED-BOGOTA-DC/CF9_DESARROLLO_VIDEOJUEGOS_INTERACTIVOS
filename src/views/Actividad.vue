  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch.mb-5
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conocimiento en videojuegos
        p.mb-4 Identificar los diferentes componentes usados en la programación de eventos y personajes en los videojuegos.
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Componentes interfaces de usuario
        p.mb-4 Identificar los eventos de los componentes usados en el diseño de interfaces de usuario.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
